...
class WellnessReceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const WellnessReceiptDetailPage({
    Key? key,
  ...
  @override
  _WellnessReceiptDetailPageState createState() =>
      _WellnessReceiptDetailPageState();
}

class _WellnessReceiptDetailPageState
    extends State<WellnessReceiptDetailPage> {
