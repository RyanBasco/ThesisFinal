...
class AttractionsReceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const AttractionsReceiptDetailPage({
    Key? key,
  ...
  @override
  _AttractionsReceiptDetailPageState createState() =>
      _AttractionsReceiptDetailPageState();
}

class _AttractionsReceiptDetailPageState
    extends State<AttractionsReceiptDetailPage> {
