...
class TravelReceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const TravelReceiptDetailPage({
    Key? key,
  ...
  @override
  _TravelReceiptDetailPageState createState() =>
      _TravelReceiptDetailPageState();
}

class _TravelReceiptDetailPageState
    extends State<TravelReceiptDetailPage> {
