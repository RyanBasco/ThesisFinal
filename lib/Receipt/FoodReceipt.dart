...
class FoodReceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const FoodReceiptDetailPage({
    Key? key,
  ...
  @override
  _FoodReceiptDetailPageState createState() =>
      _FoodReceiptDetailPageState();
}

class _FoodReceiptDetailPageState
    extends State<FoodReceiptDetailPage> {
