...
class TransportationReceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const TransportationReceiptDetailPage({
    Key? key,
  ...
  @override
  _TransportationReceiptDetailPageState createState() =>
      _TransportationReceiptDetailPageState();
}

class _TransportationReceiptDetailPageState
    extends State<TransportationReceiptDetailPage> {
