...
class ShoppingreceiptDetailPage extends StatefulWidget {
  final String establishmentName;
  final String address;
  final String date;
  final double totalSpend;

  const ShoppingreceiptDetailPage({
    Key? key,
  ...
  @override
  _ShoppingreceiptDetailPageState createState() =>
      _ShoppingreceiptDetailPageState();
}

class _ShoppingreceiptDetailPageState
    extends State<ShoppingreceiptDetailPage> {
