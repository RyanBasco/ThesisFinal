        ...
        if (event.snapshot.value != null) {
          ...
          if (mounted) {
            setState(() {
              ...
              print('Registration status: $_isRegistered'); // Debug print
            });
          }
        }
      }
          ...
          child: Column(
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    _buildTravelRegistrationBox(), // Maintain only the "Travel Registration" box

                    // Conditionally show the "View QR Code" button
                    if (_isRegistered)
                      GestureDetector(
                        onTap: () {
                          // Replace with actual formId, firstName, and lastName
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(
                                Icons.qr_code, // Icon for "View QR Code"
                                size: 60,
