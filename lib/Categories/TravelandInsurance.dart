...
import 'package:testing/Receipt/TravelInsuranceReceipt.dart';
...
class _TravelandinsuranceState extends State<Travelandinsurance> {
    ...
    try {
      ...
      if (visitsSnapshot.exists) {
        visitsSnapshot.children.forEach((document) {
          ...
          if (visitorUid == uid && visitData['Category'] == 'Travel Insurance') {
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => TravelReceiptDetailPage(
