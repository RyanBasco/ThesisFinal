...
class Localtoursandguides extends StatefulWidget {
  @override
  _LocaltoursandguidesState createState() => _LocaltoursandguidesState();
}

class _LocaltoursandguidesState extends State<Localtoursandguides> {
      ...
      if (visitsSnapshot.exists) {
        visitsSnapshot.children.forEach((document) {
          if (document.value != null) {
            ...
            if (visitData['User'] != null && 
                visitData['User']['UID'] == uid && 
                visitData['Category'] == 'Local Tours and Guides' &&
                visitData['Establishment'] != null) {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'Local Tours and Guides History',
