...
import 'package:testing/Receipt/AttractionsReceipt.dart';
import 'package:testing/Groups/QrPage.dart';
import 'package:testing/TouristDashboard/TouristProfile.dart';
import 'package:testing/TouristDashboard/UserDashboard.dart';

class Attractionsandactivities extends StatefulWidget {
  @override
  _AttractionsandactivitiesState createState() => _AttractionsandactivitiesState();
}

class _AttractionsandactivitiesState extends State<Attractionsandactivities> {
    ...
    try {
      ...
      if (visitsSnapshot.exists) {
        visitsSnapshot.children.forEach((document) {
          ...
          if (visitUid == uid && visitData['Category'] == 'Attractions and Activities') {
  ...
  void _navigateToDetail(Map<String, dynamic> visit) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AttractionsReceiptDetailPage(
