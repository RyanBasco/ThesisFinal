...
class CombinedArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tomatoStartAngle = 3.14 * 0.9; // Start angle adjusted
    final tomatoSweepAngle = 3.14 * 0.7; // Sweep 40% of the circle

    canvas.drawArc(rect, tomatoStartAngle, tomatoSweepAngle, false, tomatoRedPaint);

    // Draw the light green arc (50% of the circle)
    final lightGreenStartAngle = 3.14 * 0.1; // Start angle adjusted to bottom
    final lightGreenSweepAngle = 3.14 * 0.8; // Sweep 50% of the circle
    ...
    final lightBlueStartAngle = 3.14 * 1.6; // Start angle for light blue arc
    final lightBlueSweepAngle = 3.14 * 0.25; // Sweep 25% of the circle
    ...
    final lightGreyStartAngle = 3.14 * 1.85; // Start angle adjusted
    final lightGreySweepAngle = 3.14 * 0.25; // Sweep 50% of the circle
