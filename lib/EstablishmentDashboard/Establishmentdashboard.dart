...
class _EstablishmentDashboardPageState extends State< EstablishmentDashboardPage> {
  ...
  if (index == 0) { // Check if "Home" option is tapped
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => EstablishmentDailyPage()), // Navigate to RegisterAsIndividualPage
    );
  } else if (index == 3) { // Check if "Itinerary" option is tapped
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => EstablishmentDailyPage()), // Navigate to ItineraryPage
    );
  } else if (index == 4) { // Check if "Itinerary" option is tapped
    Navigator.push(
      context,
